...
from models import SimulacaoProg


simulacaoProg_routes = Blueprint('simulacaoProg_routes', __name__)
...
@simulacaoProg_routes.route('/pcp/api/ConsultaSimulacoes', methods=['GET'])
@token_required
...
@simulacaoProg_routes.route('/pcp/api/consultaDetalhadaSimulacao', methods=['GET'])
@token_required
...
@simulacaoProg_routes.route('/pcp/api/atualizaInserirSimulacao', methods=['POST'])
@token_required
def post_atualizaInserirSimulacao():

    data = request.get_json()
    nomeSimulacao = data.get('nomeSimulacao')
    arrayAbc = data.get('arraySimulaAbc','[]')
