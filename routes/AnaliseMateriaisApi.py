...
def post_DetalhaNecessidade():
    ...
    dados = AnaliseMateriais.AnaliseMateriais(codPlano, '',consideraPedBloq,codComponente,nomeSimulacao).detalhaNecessidade(nomeSimulacao)
    #controle.salvarStatus(rotina, ip, datainicio)
...
@analiseMP_routes.route('/pcp/api/comprometidoOP', methods=['GET'])
@token_required
def ger_comprometidoOP():



    dados = AnaliseMateriais.AnaliseMateriais().sqlEstoqueComprometido()
    #controle.salvarStatus(rotina, ip, datainicio)
...
@analiseMP_routes.route('/pcp/api/comprometidoCompras', methods=['GET'])
@token_required
