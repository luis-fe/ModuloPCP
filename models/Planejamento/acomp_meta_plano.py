...
def MetasFase(Codplano, arrayCodLoteCsw, dataMovFaseIni, dataMovFaseFim, congelado = False, dataFrame2 = None, faltaProgramarZerado = False):
    ...
    if congelado == False:
        ...
        if diaAtual >= IniFat:
            ...
            sqlMetas['estoque-saldoAnt'] = np.where(sqlMetas['estoque-saldoAnt'] < 0, sqlMetas['estoque-saldoAnt']*1.70 , 0)

            sqlMetas['FaltaProgramar1'] = sqlMetas['previsao']-(0+ sqlMetas['carga'])
        try:
