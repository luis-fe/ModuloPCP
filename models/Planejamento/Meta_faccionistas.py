...
def MetasFaccionistas(codigoPlano,arrayCodLoteCsw,dataMovFaseIni, dataMovFaseFim, congelado):
    ...
    sql = """select nomecategoria as categoria, codfaccionista, "Capacidade/dia" from "PCP".pcp."faccaoCategoria" fc  """
    consulta2 = pd.read_sql(sql,conn)

    #Passo3 Realizando o merge
    consulta1 = pd.merge(consulta1,consulta2,on='categoria')
