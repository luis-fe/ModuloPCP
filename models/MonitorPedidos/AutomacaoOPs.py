...
def PesquisandoReduzido():
    ...
    consulta = """select "codItemPai" as "codProduto", "codSortimento" as "codSortimento", "codSeqTamanho" as "seqTamanho", "codigo" as codreduzido, categoria  from "PCP".pcp.itens_csw ic """
